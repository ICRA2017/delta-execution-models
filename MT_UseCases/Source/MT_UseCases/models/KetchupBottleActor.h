...
#include "KetchupBottleActor.generated.h"

UCLASS()
class MT_USECASES_API AKetchupBottleActor : public ASimulationActor
{
	GENERATED_BODY()

public:
	AKetchupBottleActor(const FObjectInitializer& objectInitialiser);
