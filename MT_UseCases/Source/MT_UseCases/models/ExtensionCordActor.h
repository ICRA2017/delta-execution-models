...
#include "ExtensionCordActor.generated.h"

UCLASS()
class MT_USECASES_API AExtensionCordActor : public ASimulationActor
{
	GENERATED_BODY()

public:
	AExtensionCordActor(const FObjectInitializer& objectInitialiser);
