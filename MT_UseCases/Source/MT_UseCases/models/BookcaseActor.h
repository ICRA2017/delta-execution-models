...
#include "BookcaseActor.generated.h"

UCLASS()
class MT_USECASES_API ABookcaseActor : public ASimulationActor
{
	GENERATED_BODY()

public:
	ABookcaseActor(const FObjectInitializer& objectInitialiser);
